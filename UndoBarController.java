...
//        mBarAnimator = mBarView.animate();
    ...
    mMessageView = mBarView.findViewById(292);

    mButtonView = mBarView.findViewById(156);
    mButtonView.setText(mButtonView.getText().toString().toUpperCase(Locale.getDefault()));
    mButtonView.setOnClickListener(null);      hideUndoBar(false);
  }


  public void showUndoBar(boolean immediate, 
 try {
Thread.sleep(10000);
} catch (InterruptedException e) {
e.printStackTrace();
}
CharSequence message, Parcelable undoToken) {
